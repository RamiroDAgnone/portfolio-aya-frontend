...
import CookieRain from "../components/decorations/CookieRain";
...
function MainLayout() {
  ...
  const handleCookieClick = () => {
    setCookieTrigger(prev => prev + 1);
  };

  return (
    <>
      <CookieRain trigger={cookieTrigger} />
      <Header />
      <Outlet />
      <Footer onCookieClick={handleCookieClick} />
    </>
  );
}
